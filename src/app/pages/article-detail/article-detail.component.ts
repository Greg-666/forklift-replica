...
export class ArticleDetailComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.blogService.getArticleById(id).subscribe(article => {
      ...
      this.title.setTitle(article.title + ' | Forklift Replica');
  ...
  get displayTitle(): string {
    ...
    return this.currentLang === 'en' && this.article.title_en
  ...
  get displayContent(): string {
    if (!this.article) return '';
    return this.currentLang === 'en' && this.article.content_en
      ? this.article.content_en
      : this.article.content;
  }

  get displaySummary(): string {
    if (!this.article) return '';
    return this.currentLang === 'en' && this.article.summary_en
      ? this.article.summary_en
